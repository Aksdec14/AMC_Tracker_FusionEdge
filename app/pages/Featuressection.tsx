...
const FEATURES = [
    {
        ...
        image: "/images/feature-contract-repository.png",
    ...
    },
    {
        ...
        image: "/images/feature-renewal-alerts.png",
    ...
    },
    {
        ...
        image: "/images/feature-service-history.png",
    ...
    },
    {
        ...
        image: "/images/feature-vendor-performance.png",
...
function FeaturePlaceholder({ gradient, icon, title }: { gradient: string; icon: React.ReactNode; title: string }) {
    return (
        <div className={`w-full h-full rounded-2xl bg-gradient-to-br ${gradient} flex flex-col items-center justify-center gap-4 p-8`}>
            <div className="w-16 h-16 rounded-2xl bg-white/20 flex items-center justify-center text-white">
                {icon}
            </div>
            <p className="text-white/80 text-sm font-medium text-center max-w-[160px] leading-snug">{title}</p>
...
export default function FeaturesSection() {
    ...
    return (
        <section className="relative w-full bg-[#f8f8fc] py-20 overflow-hidden">
            ...
            <div className="mx-auto w-full max-w-[1200px] px-6 lg:px-10">
                ...
                <div className="mb-12">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                        <div>
                            <h2 className="font-extrabold tracking-tight text-[#0f0f1a] text-[1.8rem] sm:text-[2.2rem] leading-tight mb-2">
                            ...
                            <p className="text-[#5a5a78] text-[0.95rem] max-w-[560px] leading-relaxed">
                                FusionEdge can be configured to fit your contract types, asset categories, vendor setups, and approval workflows — built to work exactly like your facility does.
                            </p>
                        </div>
                        {/* Progress dots */}
                ...
                <div className="flex flex-col lg:flex-row gap-6 items-stretch">
                    ...
                    {/* ── LEFT: Active feature panel — fixed height, all slides stacked ── */}
                    <div className="lg:flex-1 flex flex-col" style={{ height: "520px" }}>
                        <div className="relative rounded-2xl overflow-hidden flex-1 flex flex-col">
                            {FEATURES.map((f, i) => (
                                ...
                                >
                                    ...
                                    {/* Content at bottom — fixed height so nothing reflows */}
                                    <div className="bg-white px-6 py-5 border border-slate-100 border-t-0 rounded-b-2xl" style={{ minHeight: "148px" }}>
                    ...
                    {/* ── RIGHT: Feature list — fixed height items, no expansion ── */}
                    <div className="lg:w-[320px] flex-shrink-0 flex flex-col gap-3" style={{ height: "520px" }}>
                        {FEATURES.map((f, i) => (
                            <button
                                key={f.id}
                                onClick={() => goTo(i)}
                                ...
                                style={{
                                    background: i === active ? "white" : "rgba(255,255,255,0.6)",
                                    borderColor: i === active ? "rgba(75,48,128,0.2)" : "transparent",
                                    boxShadow: i === active ? "0 4px 20px rgba(75,48,128,0.10)" : "none",
                            ...
                            >
                                ...
                                <div
                                    ...
                                    style={{ transition: "transform 0.2s ease", transform: i === active ? "scale(1.04)" : "scale(1)" }}
                                >
                                    {f.icon}
                                </div>
                                ...
                                >
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden>
                                        <path d="M4 8h8M9 5l3 3-3 3" stroke="#4B3080" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </div>
                            </button>
                        ))}
